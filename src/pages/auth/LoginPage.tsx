...
import { Sparkles, Mail, Lock, Chrome, Eye, EyeOff } from 'lucide-react';
...
export default function LoginPage() {
  ...
  return (
    <>
      <PageMeta title="Login — LifeBoard AI" description="Sign in to your LifeBoard AI account." />
        ...
        >
          <div className="glass-card p-8">
            <div className="text-center mb-8">
              ...
              <h1 className="font-sora text-2xl font-bold text-foreground">Welcome back</h1>
              <p className="text-sm text-muted-foreground mt-1">Sign in to continue organizing your life</p>
            </div>
